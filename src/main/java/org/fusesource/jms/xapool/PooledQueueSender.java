...
/**
 * A pooled {@link javax.jms.QueueSender}
 */
public class PooledQueueSender extends PooledProducer implements QueueSender {

    public PooledQueueSender(final QueueSender messageProducer,
                             final Destination destination) throws JMSException {
        super(messageProducer, destination);
    }

    public void send(final Queue queue, final Message message, final int i, final int i1, final long l)
            throws JMSException {
